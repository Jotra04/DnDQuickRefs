...
Examples:
\begin{itemize}
\item draw / sheathe weapon
\item open door / pull lever / extinguish small flame
\item take an item from a container / pick up an item
\item stuff something into your mouth / drink something
\item hand someone something / accept something from someone
\end{itemize} 
\section{Dropping prone \small (PHB p.190 + 292)}
\begin{itemize}
\item You can drop prone for free
\item Standing back up requires half your movement
\item You cannot stand up when your movement is 0
\item While prone, you can only crawl, costing 2ft for every ft of movement and you have disadvantage on attack rolls
\item An attack against you has advantage when the attacker is within 5ft otherwise the attack has disadvantage
\end{itemize}
\section{Search \small (PHB p.193)}
You stop paying attention to the combat and instead focus on finding something, depending on the nature of your search, you DM may have you roll a Perception(WIS) or Investigation(INT) check.
